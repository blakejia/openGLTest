...
CCScene* GlDraw::createScene()
{
    auto s = Scene::create();
 
    auto layer = GlDraw::create();
...
void GlDraw::visit(cocos2d::Renderer *renderer, const cocos2d::Mat4& transform, uint32_t parentFlags)
{
    Layer::visit(renderer, transform, parentFlags);
    _command.init(_globalZOrder);
    _command.func = CC_CALLBACK_0(GlDraw::onDraw, this);
